      ...
      >
        ...
        <div>
          <span className="text-gray-400 text-sm">
            All prompts are private and can be viewed in your profile. If you
            would like to share them with everyone, select "Public". We
            encourage sharing amazing prompts with the world.
          </span>
        </div>
